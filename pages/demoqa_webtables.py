...
#к дом.задаче 2 занятие 11
    ...
    #к дом.задаче 3 занятие 12

        self.check_sort = WebElement(driver, 'div.rt-table > div.rt-tbody')# таблица с внесенными данными
        self.head_check = WebElement(driver,'div.rt-table > div.rt-thead.-header > div.rt-tr > div.rt-th.rt-resizable-header')
