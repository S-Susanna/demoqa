...
def test_visible_accordion_default(browser):
    ...
    assert not accordion_page.section_text1_check.visible()#проверка на невидимость текста
    # assert accordion_page.section_text2_check.visible()
    assert not accordion_page.section_text2_check.visible()#проверка на невидимость текста
    # assert accordion_page.section_text3_check.visible()
    assert not accordion_page.section_text3_check.visible()#проверка на невидимость текста