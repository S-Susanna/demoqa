...
#
    ...
    assert demo_qa_page.elem1.get_text() == '© 2013-2020 TOOLSQA.COM | ALL RIGHTS RESERVED.' # проверить на наличие текста на странице в подвале
#
    ...
    assert demo_qa_page.elem2.get_text() == 'Please select an item from left to start practice.' # проверить на наличие текста на странице
